...
-  **2.2 Language Detection**
  -  2.2.a `detect_language_from_extension()`
  ...
  - 2.2.b `detect_language_from_filename()`
...
-  **2.4 File Metadata**
  ...
  -  2.4.b Language stored in `FileInfo`
  ...
  -  2.4.c Binary/Text flags stored in `FileInfo`
...
-  **2.5 Line Statistics**
  ...
  -  2.5.c Store values in `FileInfo`
...
-  **2.6 Comment Statistics**
  -  2.6.a Count Python comments
  ...
  -  2.6.c Store comment count in `FileInfo`
