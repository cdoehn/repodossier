...
def render_docs_export_with_optional_model(
    export_or_context: object,
    *,
    use_model_renderer: bool = False,
    legacy_renderer: object | None = None,
) -> str:
    """Render a docs export through legacy behavior or explicit model opt-in."""
    ...
    if use_model_renderer:
        ...
        return render_docs_export_from_model(export_or_context)
