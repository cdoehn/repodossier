...
ALLOWED_LEGACY_NAME_PATHS = {
    "README.md",
    "pyproject.toml",
    "src/repocontext.egg-info/SOURCES.txt",
    "src/repocontext.egg-info/entry_points.txt",
    "src/repocontext.egg-info/top_level.txt",
    "src/repocontext/__init__.py",
    "src/repocontext/__main__.py",
    "src/repocontext/cli.py",
    "src/repodossier.egg-info/SOURCES.txt",
    "src/repodossier.egg-info/entry_points.txt",
