...
""",
    ...
    full_result = _run_repodossier(tmp_path, "full")
    ...
    ai_result = _run_repodossier(tmp_path, "export-ai")
    ...
    docs_result = _run_repodossier(tmp_path, "export-docs")
    ...
    changed_result = _run_repodossier(tmp_path, "changed", "--no-diff")
